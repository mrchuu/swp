                ...
                <div class="row">
                    <div class="col-lg-12 align-self-center">
                        <div class="row align-content-center justify-content-center">
                            <div class="col-lg-6">
                                <form id="contact" action="EditLessonContent" method="post">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <h2 class="text-center" >Edit Lesson Content</h2>
                                        </div>
                                        <div class="col-lg-12">
                                            <fieldset>
                                                <label>Tên Bài Học</label>
                                                <input name="lesson_Name" type="text" id="lesson_Name" value="${requestScope.lesson_Name}"  required="">
                                            </fieldset>
                                        </div>
                                            <div class="col-lg-12" style="display: none">
                                            <fieldset>
                                                <label>Id Bài Học</label>
                                                <input name="lesson_id" type="text" id="lesson_Name" value="${requestScope.lesson_id}"  required="">
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-12">
                                            <fieldset>
                                        ...
                                        <div class="col-lg-12 iframeWrapper">
                                            <fieldset>
                                                <div id="target">
                                                    <iframe id="demoVid" src="${requestScope.lesson_Video}"></iframe>
                                                </div> 
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset>
                                                ...
                                                <textarea name="Lesson_desc" cols="40" rows="6" >${requestScope.Lesson_desc}</textarea>
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-12">
                                            <fieldset>
                                                <button type="submit" id="form-submit" class="button">Edit</button>
                                            </fieldset>
                                        </div>
